...
async def rename(ctx, user: discord.Member, *, rename_to):
    ...
    print(
        f"Attempting to rename {user.name} to '{rename_to}' in {ctx.guild.name}.")
    ...
    if ("reset" in rename_to):
        print(
            f"The nickname of '{user.name}' has been reset in {ctx.guild.name}.")
    ...
    print(consoleNewLine)
    print(
        f"Successfuly renamed {user.name} to '{rename_to}' in {ctx.guild.name}!")
    print(consoleDivider)
...
async def renameAll(ctx, *, rename_to):
    ...
    print(
        f"Attempting to rename all users to '{rename_to}' in {ctx.guild.name}.")
    ...
    if ("reset" in rename_to):
        for user in list(ctx.guild.members):
            try:
                ...
                numberFailed += 1
                print(
                    f"Could not reset the nickname of {user.name} in {ctx.guild.name}. Do you have the required permissions to rename this user?")
    ...
    print(
        f" {numberFailed}  -  Number of users that failed to renamed to '{rename_to}'.")
    print(consoleNewLine)
    print(
        f"Successfuly renamed {numberRenamed} users to '{rename_to}' in {ctx.guild.name}!")
    print(consoleDivider)
...
async def dm(ctx, user: discord.Member, *, message):
    ...
    print(
        f"Attempting to DM {user.name} the message '{message}' in {ctx.guild.name}.")
    ...
    print(
        f"Successfuly DM'd {user.name} the message '{message}' in {ctx.guild.name}.")
...
async def dmAll(ctx, *, message):
    ...
    print(
        f"Attempting to DM all members the message '{message}' in {ctx.guild.name}.")
    ...
    print(consoleNewLine)
    print(
        f"Successfuly DM'd the message '{message}' to all members in {ctx.guild.name}.")
    print(consoleDivider)
...
async def spam(ctx, amount, *, message):
    ...
    print(
        f"Attempting to spam '{message}' {amount} times in {ctx.guild.name}.")
    ...
    print(consoleNewLine)
    print(
        f"Successfuly spammed '{message}' {amount} amount of times in {ctx.guild.name}!")
    print(consoleDivider)
...
async def rolespam(ctx, amount, *, roleName):
    ...
    print(
        f"Attempting to create {amount} versions of a role called '{roleName}' in {ctx.guild.name}.")
    amountOfTimes = int(amount)
    count = 0
    while count < amountOfTimes:
        try:
            ...
            print(
                f"Could not create {amount} versions of a role called '{roleName}' in {ctx.guild.name}.")
    ...
    print(consoleNewLine)
    print(
        f"Successfuly created {amount} versions of a role called '{roleName}' in {ctx.guild.name}.")
    print(consoleDivider)
...
async def channelspam(ctx, amount, *, channelName):
    ...
    print(
        f"Attempting to create {amount} versions of a text channel called '{channelName}' in {ctx.guild.name}.")
    amountOfTimes = int(amount)
    count = 0
    while count < amountOfTimes:
        try:
            ...
            print(
                f"Could not create {amount} versions of a text channel called '{channelName}' in {ctx.guild.name}.")
    ...
    print(consoleNewLine)
    print(
        f"Successfuly created {amount} versions of a text channel called '{channelName}' in {ctx.guild.name}.")
    print(consoleDivider)
        ...
        if condition.lower() == "channels":
            ...
            for channel in list(ctx.guild.channels):
                try:
                    ...
                    numberFailed += 1
                    print(
                        f"You do not have permission to list channels in {ctx.guild.name}.")
            ...
            print(
                f" {numberFailed}  -  Number of channels that failed to be retrieved.")
            print(consoleDivider)
